...
public class GuideActivity extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
	    ...
	    if((ln.equals("Espa�ol"))|| (ln.equals("Spanish")))
        {
	    	TextView t1 = (TextView) findViewById(R.id.thanks);        
	        t1.setText("Gracias por usar mi aplicaci�n.");
    ...
    //    webview.setBackgroundResource(R.drawable.openbook);
        ...
        for (int i = 1; i < (data.getName().size()); i++) {
            ...
            if((ln.equals("Espa�ol"))|| (ln.equals("Spanish")))
            {
        	   stg1 = stg1 + "Nombre: " + data.getName().get(i) + "<br>" + " Direcci�n: "+data.getAddress().get(i) + "<br>" + " clasificaci�n= "+data.getRating().get(i) + "<br>" + "<br>";           
            }
    	    else
    	    {
