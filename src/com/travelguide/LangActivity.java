...
Locale locale;
 ...
 public void onCreate(Bundle savedInstanceState) {
     ...
     spin.setOnItemSelectedListener(new OnItemSelectedListener(){
          ...
          if ((parent.getItemAtPosition(pos).toString()).equals("Ingl�s")||(parent.getItemAtPosition(pos).toString()).equals("English")) {
          ...
          else if ((parent.getItemAtPosition(pos).toString()).equals("Espa�ol")||(parent.getItemAtPosition(pos).toString()).equals("Spanish")) {
